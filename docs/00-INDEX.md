...
| `reimpl/mvp-server/README.md` | reimpl | draft | **Runnable** reference backend (Python): SSO+envelope REST, in-process self-test (8/8), + Proton launch diagnostic (client stalls in early init on iGPU/headless). |
