#!/usr/bin/env python3
"""Scan .text for ANY instruction encoding the disp32 0x00000870 and classify
read vs write by the opcode byte that precedes the ModRM."""
import struct
